      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-ink-400 mb-4 max-w-md">
              Tanzania's trusted escrow platform for social sellers. Shop safely, sell confidently.
              Your money is protected until you receive your goods.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-ink-400 hover:text-gold-400 transition-colors">
        ...
        <div className="border-t border-ink-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-ink-500 text-sm">
            © 2026 Biz-Salama. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-ink-500 hover:text-ink-300 text-sm">Privacy Policy</a>
            <a href="#" className="text-ink-500 hover:text-ink-300 text-sm">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
