...
export const TRANSLATIONS: Dict = {
  ...
  // ─── Ledger / Admin
  "ledger.title": { sw: "Daftari la Fedha", en: "Financial Ledger" },
  "ledger.subtitle": {
    sw: "Mfumo wa kulipia wa hesabu mbili — kila shilingi inafuatiliwa.",
    en: "Double-entry bookkeeping — every shilling tracked and reconciled.",
  },
  "ledger.tab.payouts": { sw: "Malipo", en: "Payouts" },
  "ledger.tab.disputes": { sw: "Migogoro", en: "Disputes" },
  "ledger.tab.accounts": { sw: "Akaunti", en: "Accounts" },
  "ledger.no_payouts": { sw: "Hakuna malipo bado.", en: "No payouts yet." },
  "ledger.no_disputes": { sw: "Hakuna migogoro hai.", en: "No active disputes." },
  "ledger.payout.amount": { sw: "Kiasi", en: "Amount" },
  "ledger.payout.role": { sw: "Mpokeaji", en: "Role" },
  "ledger.payout.dest": { sw: "Mahali", en: "Destination" },
  "ledger.payout.status": { sw: "Hali", en: "Status" },
  "ledger.payout.disburse": { sw: "Lipa Sasa", en: "Disburse" },
  "ledger.payout.disbursing": { sw: "Inalipa…", en: "Disbursing…" },
  "ledger.payout.paid_at": { sw: "Imelipwa", en: "Paid" },
  "ledger.dispute.opened_by": { sw: "Imefunguliwa na", en: "Opened by" },
  "ledger.dispute.reason": { sw: "Sababu", en: "Reason" },
  "ledger.dispute.auto_resolves": { sw: "Itamalizika kiotomatiki", en: "Auto-resolves" },
  "ledger.dispute.resolve_seller": { sw: "Achilia kwa Muuzaji", en: "Release to seller" },
  "ledger.dispute.resolve_buyer": { sw: "Rudisha kwa Mnunuzi", en: "Refund to buyer" },
  "ledger.dispute.resolution": { sw: "Maamuzi", en: "Resolution" },
  "ledger.fee_quote": { sw: "Hesabu ya Ada", en: "Fee Calculator" },
  "ledger.mode": { sw: "Aina", en: "Mode" },
  "ledger.deal": { sw: "Thamani ya Biashara", en: "Deal value" },
  "ledger.supplier_cost": { sw: "Bei ya Asili", en: "Supplier cost" },
  "ledger.buyer_pays": { sw: "Mnunuzi Hulipa", en: "Buyer pays" },
  "ledger.seller_gets": { sw: "Muuzaji Anapata", en: "Seller gets" },
  "ledger.hawker_gets": { sw: "Mchuuzi Anapata", en: "Hawker gets" },
  "ledger.platform_fee": { sw: "Ada ya Mfumo", en: "Platform fee" },
